...
function PriceTag({ amount, currency = "USD", showCurrency = false, salePrice }) {
  return (
    <span style={{
      flex: "none",
      padding: "5px 12px",
      ...
      {showCurrency && <span style={{ opacity: 0.7, fontWeight: 400, marginLeft: 4 }}>{currency}</span>}
    </span>
  );
}
    ...
    >
      ...
      {product.badge && (
        <div style={{
          ...
          padding: "5px 12px",
          borderRadius: 999,
          background: product.badge.startsWith("−") ? "var(--anime-pink)" : "var(--anime-yellow)",
          color: "var(--anime-ink)",

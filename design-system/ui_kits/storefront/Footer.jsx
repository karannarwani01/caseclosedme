...
function Footer() {
  ...
  const menu = [
    {
      title: "Shop",
      items: ["All products", "Funko Pops", "Trading Cards", "Figures"],
    },
    {
      title: "Help",
      items: ["Shipping", "Returns", "Track an order", "Contact"],
    },
    ...
    >
      ...
      >
        <div>
          ...
          >
            Pop‑culture collectibles, hand‑checked and packed by hand. Shipped
            the next day.
          </p>
        </div>
        {menu.map((col) => (

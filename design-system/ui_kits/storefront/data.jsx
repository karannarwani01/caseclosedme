...
const PRODUCTS = [
  {
    ...
    variants: [
      { name: "Condition", values: ["Mint", "Near Mint", "Played"] },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { name: "Edition", values: ["Standard", "Signature"] },
    ],
  },
  {
    ...
    description: "Sword & Shield era. Sleeved, top-loaded, sent in a bubble mailer.",
  ...
  },
  {
    ...
    badge: "−15%",
    salePrice: 446.25,
    description: "12-inch polystone. Two interchangeable head sculpts, three pairs of hands.",

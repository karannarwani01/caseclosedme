// Country dialing codes for the phone-number selector.
// Flag emoji are derived from the ISO-3166 alpha-2 code at runtime, so we only
// store name/iso/dial here (no hand-typed emoji to get wrong).

export type Country = { name: string; iso: string; dial: string };

/** Turn an ISO-3166 alpha-2 code ("AE") into its flag emoji ("🇦🇪"). */
...
// Default selection for the store (UAE).

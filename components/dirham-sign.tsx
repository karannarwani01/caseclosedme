...
export function DirhamSprite() {
  return (
    ...
    >
      <symbol id={DIRHAM_SYMBOL_ID} viewBox="0 0 85.41 74.28">
        <path d={DIRHAM_PATH} />
      </symbol>
    </svg>
  );
